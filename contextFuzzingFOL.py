...
class ContextFuzzing:
    ...
    def fuzzing_process(self, x, y, budget):
        ...
        x_ctx_label_list, x_ctx_similarity_list, x_ctx_distance_list, x_gini_list, x_fol_list, x_ctx_grad_list, x_ctx_inc_list = [], [], [], [], [], [], []
        ...
        while True:
            ...
            for batch_idx in range(len(x)):
                cur_idxs = np.array(range(batch_idx, (batch_idx+1)))
...
if __name__ == "__main__":
    ...
    for param_index in [0, 1, 3]:
        ...
        ae_data_path = base_path + "/contextfuzz_fol/ae/"
